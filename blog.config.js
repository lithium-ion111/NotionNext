...
const BLOG = {
  ...
  HOME_BANNER: process.env.NEXT_PUBLIC_HOME_BANNER || false, // ホームのバナーを非表示にする
  AUTHOR: 'ホワサバ勉強会保管庫', // ←ここを好きな名前に
  BIO: 'ホワサバ勉強会の保管庫です。最新の攻略情報をまとめています。', // ←紹介文
  AVATAR: '', // アイコンを非表示にする
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-coral.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ホワイトアウトサバイバル, ホワサバ, 攻略, 勉強会', // 网站关键词 英文逗号隔开
